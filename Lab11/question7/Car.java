...
public class Car {
	...
	public static void testCar() {
		...
		// ArrayIndexOutOfBoundsException becomes IndexOutOfBoundsException!
		// The error message inside the exception object changes too!
		catch (IndexOutOfBoundsException ex) {
			// The message inside an IndexOutOfBoundsException simply indicates
			// the index which was outside the bounds of the arraylist, in this
			// case 7, and the size of the arraylist, which is 7 too here.
			// We must use the equals method because obviously the string which is// stored
			// inside the exception object is only generated at runtime by// Java, since
			// Java cannot know in advance that our program is going
			// to try to use an object which is past the end of the arraylist).
			System.out.println(ex.getMessage().equals("Index 7 out of bounds for length7"));
		}
